  ...
  return (
    <section className="max-container">
      ...
      <div className="py-16">
        ...
        <div className=" mt-5 flex flex-col gap-3 text-slate-500 ">
          <p>
            I{"'"}ve worked with all sorts of projects up my skills and teaming
              ...
              return (
                ...
                >
                  <div>
                    ...
                    <p className=" text-black-500 font-medium text-base" style={{margin:0}} >{experience.companyName}</p>
                  </div>
                  <ul className=" my-5 list-disc ml-5 space-y-2">
                    {experience.points.map((point, index) => {
                      return <li className=" text-black font-normal pl-1 text-sm" key={index}>{point}</li>;
                    })}
                  </ul>
                </VerticalTimelineElement>
              );
